...
public class Email {
	...
	public static String getTestSummaryReport() throws IOException {
		File dump = new File(System.getProperty("user.dir") + "/Reports/"
				+ Property.getProperty("ApplicationName") + "-feature-overview-dump.xml");
		String content = FileUtils.readFileToString(dump,Charset.defaultCharset());
		...
		String mailText = "<table cellspacing=\"0\" cellpadding=\"0\" border=\"1\" style=\"table-layout:fixed;font-size:13px;font-family:arial,sans,sans-serif;border-collapse:collapse;border:1px solid rgb(204,204,204)\">"
				...
				+ scenarioPassed + "</td></tr><tr style=\"height:21px\">"
				+ "<td style=\"vertical-align:bottom\"align=\"center\"><span style=\"font-family:arial;font-size:small\">Scenarios Failed"
				+ "</span></td><td  style=\"vertical-align:bottom\" align=\"center\">" + scenarioFailed
				+ "</td></tr><tr style=\"height:21px\"><td style=\"vertical-align:bottom\"align=\"center\">"
	...
	public static void main(String args[]) throws Exception, IOException {
		...
		final String senderMailId = Property.getProperty("Sendermailid");
		final String senderPassword = Property.getProperty(EncryptDecrypt.decryptPassword("Senderpassword"));
		String toReceipientMailId = Property.getProperty("TOReceipient");
		String ccReceipientMailId = Property.getProperty("CCReceipient");
		String applicationName = Property.getProperty("ApplicationName");
		String reportFile = Property.getProperty("ApplicationName") + "-test-results.pdf";
		...
		try {
			...
			message.addRecipients(Message.RecipientType.TO, InternetAddress.parse(toReceipientMailId));
			message.addRecipients(Message.RecipientType.CC, InternetAddress.parse(ccReceipientMailId));
			message.setSubject(applicationName + " Automation Test Summary Report in " + System.getProperty("env")
					+ " - " + getDate());

			// create the message part
			String fileAttachment = reportFilePath;
			StringBuffer body = new StringBuffer("<html>Hi, <br><br>Following is the Test Summary Report for ");
			body.append(applicationName);
			body.append(" : " + System.getProperty("product"));
			body.append("<br><br>");
			body.append(getTestSummaryReport());
			body.append("<br><br> Thanks,<br>QBAutomation Team");
			body.append("</html>");
