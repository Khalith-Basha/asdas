...
/**
 * The Image class is a wrapper class to allow centralized control of common web
...
public class Image extends WebWidget {
	 ...
	 *
	 * @param id
	 *            the locator or image object identifier
	 */
	...
	/**
	 * Image object constructor to override object name with sLabel variable.
	 *
	 * @param id
	 *            the locator or image object identifier
	 * @param label
	 ...
	 */
	public Image(String id, String label) {
		super(id, "Image", label);
	}
}
